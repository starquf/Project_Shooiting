...
public class Attack_RoundStopAndGo : MonoBehaviour, IState
{
    ...
    public void OnEnter()
    {
        ...
        for (int i = 0; i < bulletCount; i++)
        {
            ...
            bullet.ChangeSpeed(goSpeed);
            bullet.ChangeSpeed(0f, goStopTime);
            bullet.ChangeSpeed(bulletSpeed, stopTime + goStopTime);
        }
    }
    ...
    public void SetValue(int bulletCount, float bulletSpeed, float stopTime, string bulletType, Transform shootPos, float goSpeed, float goStopTime)
    {
        ...
        this.goStopTime = goStopTime;
    }

    public void SetValue(int bulletCount, float bulletSpeed, float bulletTwist, float stopTime, string bulletType, Transform shootPos, float goSpeed, float goStopTime)
    {
        this.bulletCount = bulletCount;
        this.bulletSpeed = bulletSpeed;
        this.shootPos = shootPos;
