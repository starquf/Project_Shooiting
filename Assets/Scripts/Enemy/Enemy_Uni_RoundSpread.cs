...
public class Enemy_Uni_RoundSpread : Enemy
{
    ...
    protected override IEnumerator LifeTime()
    {
        ...
        for (int i = 0; i < 30; i++)
        {
            RoundBullet(3, 6f, i * 10f, bulletCyan, transform);
            RoundBullet(3, 6f, i * 10f + 10f, bulletCyan, transform);
            RoundBullet(3, 6f, i * 10f + 20f, bulletCyan, transform);
    ...
    {
        attack.SetValue(bulletCount, bulletSpeed, bulletTwist, bulletType, shootPos);
        dicState[State.Attack] = attack;
